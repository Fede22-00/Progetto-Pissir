...
client.subscribe('smartparking/exit/request');
...
client.on('message', (topic, message) => {
    ...
    parentPort.postMessage({purpose:"mqtt-exit",message:id_parking});
  });
  ...
  parentPort.on('message',((data)=>{
      ...
      const topic = `smartparking/${id_parking}/exit/response`;
